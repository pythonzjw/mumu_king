...
# 「获取秘卷」按钮搜索区，按图 9 弹窗估在中下按钮区左半
CASTLE_GET_SCROLL_ROI    = (60,  1300, 600, 1550)
CASTLE_GET_SCROLL_KW     = "秘卷"   # 4 字「获取秘卷」OCR 易掉首字，缩短到 2 字提高召回
# 「秘研」按钮搜索区，按图 9 弹窗估在中下按钮区右半
CASTLE_MIYAN_BTN_ROI     = (560, 1300, 1020, 1550)
CASTLE_MIYAN_BTN_KW      = "秘研"
# 进城堡 tab 后的左上「秘研」图标搜索区，必须先点这个才弹「获取秘卷/秘研」操作框
# 实测图 6 命中 (104, 382)
CASTLE_MIYAN_ICON_ROI    = (0, 250, 250, 500)
# 点完左上图标后等弹窗出现
...
# === debug 截图环形覆盖 ===
# step_count 累计到这个数后从 0 重新开始，旧文件被覆盖。挂 debug 时防磁盘膨胀
